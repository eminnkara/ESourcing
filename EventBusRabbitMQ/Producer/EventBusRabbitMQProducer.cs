...
namespace EventBusRabbitMQ.Producer
{
    public class EventBusRabbitMQProducer
    {
        ...
        private readonly ILogger<EventBusRabbitMQProducer> logger;
        ...
        public void Publish(string queueName, IEvent @event)
        {
            ...
            {
                logger.LogWarning(ex, "Could not publish event: {EventId} after {Timeout}s ({ExceptionMessage})", @event.RequestId, $"{time.TotalSeconds:n1}", ex.Message);
            });
